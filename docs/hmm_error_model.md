# HMM Sequencing Error Model: Design Reference

This document explains the design of the Hidden Markov Model (HMM) trained by
`scripts/train_hmm_error_model.py` and the companion Jupyter notebook
`notebooks/hmm_error_model.ipynb`.
